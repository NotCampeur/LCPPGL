...
/*   Updated: 2022/07/20 15:03:35 by ldutriez         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void great_rendering(lcppgl::Context &context)
{
	...
	lcppgl::tools::Rectangle img_rect(texture.width() / 3, texture.height() / 3, texture.width() / 3, texture.height() / 3);
...
int main(void)
{
	try
	{
		...
		main_context.add_render_functor(great_rendering);
